"""
Django settings for Brafinox project.
...
SECRET_KEY = 'django-insecure-ks#!%vid3wn@wvai)i9dyr6k68gmj=5)m__)93vu7rtrj)+m+)'
...
WSGI_APPLICATION = 'Brafinox.wsgi.application'
