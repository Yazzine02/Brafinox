...
from register.views import register, home, choice_view, stock_view, client_view ,custom_login_view ,add_stock_view,view_stock_view # Importez les vues nécessaires
