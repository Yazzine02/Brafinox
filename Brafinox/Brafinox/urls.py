...
from register.views import register, home, choice_view, stock_view, client_view ,custom_login_view ,add_stock_view,view_stock_view ,export_stock_to_excel, export_to_excel
...
urlpatterns = [
    ...
    path('export_excel/', export_to_excel, name='export_excel'),    path('add-stock/', add_stock_view, name='add_stock_view'),
